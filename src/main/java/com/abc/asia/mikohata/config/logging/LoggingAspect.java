package com.abc.asia.mikohata.config.logging;
...
public class LoggingAspect {
    ...
    @Pointcut(
            "@within(com.abc.asia.mikohata.config.logging.Loggable) || "
                    + "@annotation(com.abc.asia.mikohata.config.logging.Loggable)")
